# Huendell Gardel de Barros

Segurança da Informação | SOC N1 / Blue Team

Profissional de TI em transição para cybersecurity, atuando em operações de sistemas com uso direto de CyberArk PAM e ambiente Red Hat Linux corporativo. Foco em SOC, monitoramento, análise de logs e detecção, com caminho planejado para DFIR / Perícia Digital.
...
Wazuh · SIEM · MITRE ATT&CK · Red Hat Linux · CyberArk PAM · Python · SQL · Redes (TCP/IP, DNS, DHCP, SSH, VPN) · Nmap · Wireshark
